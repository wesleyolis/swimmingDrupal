<?php
{
  $page_exe = true;
   ...
   if(arg(7) ==null || arg(8) ==null)//Age group and gender
	...
	$output.="<p class='no_print' style='padding:5px;' align='right'>".((arg(3)=='fina')?l('Base Times - '.(floor((arg(1)/4))*4),'fina/base_times/'.(floor((arg(1)/4))*4).'/'.arg(6)).' | ':'').'Included '.l('Meets','ranking/'.arg(1).'/meets/'.arg(5).'/'.$last_ranking.'/'.arg(6))." & ".l('Teams','ranking/'.arg(1).'/teams/include/'.(($cntry != arg(4) & arg(4)!='All')?arg(4):''))." | ".l('Detailed Information','ranking/'.arg(1).'/'.arg(2).'/info')."</p>";
